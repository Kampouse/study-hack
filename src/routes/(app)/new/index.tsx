...
export default component$(() => {
  ...
  const selectedStartTime = useSignal<string>("");
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <div class="space-y-2">
                      ...
                      >
                        ...
                        {Array.from({ length: 24 }, (_, i) => {
                          // If today, only show hours that haven't passed
              ...
              <Field name="EndTime">
                {(field, props) => {
                  ...
                  // Parse the selected start time to get the hour
                  const startTimeHour = selectedStartTime.value
                    ? Number.parseInt(selectedStartTime.value.split(":")[0], 10)
                    : -1;

                  const isDisabled = !selectedStartTime.value;
                  ...
                  return (
                    <div class="space-y-2">
                      ...
                      <select
                        {...props}
                        class={`w-full rounded-xl border px-4 py-3 text-[#5B3E29] shadow-sm transition-colors duration-300 ${
                          isDisabled
                            ? "cursor-not-allowed bg-gray-100 opacity-60"
                            : "bg-white/50 focus:border-[#D98E73] focus:outline-none focus:ring-2 focus:ring-[#D98E73]/20"
                        } ${
                          field.error ? "border-red-500" : "border-[#E6D7C3]"
                        }`}
                        value={field.value}
                      ...
                      >
                        ...
                        {Array.from({ length: 24 }, (_, i) => {
                          ...
                          if (startTimeHour >= 0 && i <= startTimeHour) {
                            return null;
                          }
