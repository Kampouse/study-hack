...
export default component$(() => {
  ...
  return (
    <div class="flex flex-col   gap-4 items-center justify-around  bg-white  h-fit lg:pt-4 py-10 shadow-sm">

      <img
        height={1000}
        width={1000}
        src="https://s6.imgcdn.dev/LdBZd.png"
        class=" order-last   w-96 h-72 lg:h-96 rounded-lg border-2 "
      />
      ...
      <div class="flex flex-col items-center gap-4 pb-4 order-last">
        <Form action={signin}>
        ...
        <Form action={signin}>
          ...
          <button class="button button-auth flex items-center justify-center gap-2 rounded-lg bg-[#2494ec] p-2">
            <svg
              viewBox="0 0 128 128"
              class="h-6 w-6 rounded-lg bg-white p-1"
            >
              <path
                fill="#fff"
