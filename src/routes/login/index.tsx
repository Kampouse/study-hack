...
export default component$(() => {
  ...
  return (
    <div class="flex flex-col items-center justify-around  bg-white p-20 shadow-sm">
      <div class="flex  flex-col items-center gap-10 lg:flex-row lg:gap-48">
        <div class=" order-last h-fit  w-96 rounded-lg border-2">
          <img
            height={1000}
            width={1000}
        ...
        <div class="flex flex-col items-center gap-4 pb-4">
          <div class="order-first flex  flex-col items-start gap-2 pb-10 lg:pb-4 ">
