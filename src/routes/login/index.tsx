        ...
        <div class="flex flex-col items-center gap-4 pb-4">
          ...
          <Form action={signin}>
            ...
            <input
              ...
              value="/auth/signedin"
            />
            <button class="button button-auth flex justify-center items-center gap-2 p-2 rounded-lg bg-[#272c30]">
              ...
              <span class="text-white text-xl">Continue with GitHub</span>
            </button>
          </Form>
          <Form action={signin}>
            <input type="hidden" name="providerId" value="github" />
            <input
              ...
              value="/auth/signedin"
            />
            <button class="button button-auth flex justify-center items-center gap-2 p-2 rounded-lg bg-[#2494ec]">
              <svg viewBox="0 0 128 128" class="w-6 h-6 p-1 rounded-lg bg-white">
              ...
              <span class="text-white text-xl">Continue with Google</span>
            </button>
          </Form>
        </div>
      </div>
