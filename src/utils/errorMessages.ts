...
export const ErrorMessages = {
  ...
  EVENT_CREATE_FAILED:
    "We couldn't create your event. Please check your details and try again.",
  ...
  PLACE_CREATE_FAILED:
    "We couldn't create this place. Please check your details and try again.",
  ...
  // Join request errors
  JOIN_REQUEST_FAILED:
    "We couldn't submit your request. Please check your answers and try again.",
  ...
  DATABASE_ERROR:
    "We're having trouble accessing our database. Please try again.",
  ...
  CONFIRMED_USERS_FAILED:
    "We couldn't load the attendee list. Please try again.",
...
export const FieldErrors = {
  ...
  invalidFormat: (fieldName: string) => `${fieldName} format is invalid`,
}
...
export function formatError(
  error: unknown,
  fallback = ErrorMessages.UNKNOWN_ERROR
): string {
...
export function getContextualError(
  ...
  const baseMessage =
    contextMap[resourceType][operation] || ErrorMessages.UNKNOWN_ERROR
  ...
  if (error) {
    ...
    if (
      ...
      errorMsg !== ErrorMessages.UNKNOWN_ERROR
    ) {
