import { sqliteTable, AnySQLiteColumn, uniqueIndex, integer, text, numeric, foreignKey } from "drizzle-orm/sqlite-core"
...
(table) => {
	return {
		SessionToken_unique: uniqueIndex("Sessions_SessionToken_unique").on(table.SessionToken),
	}
});
